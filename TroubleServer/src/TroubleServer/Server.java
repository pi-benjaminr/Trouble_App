...
public class Server {
	...
	protected static Integer nextGame = 100;
	
	protected static Map<Integer, String> userNames = new HashMap<Integer, String>();
	protected static Map<Integer, Integer> inGame = new HashMap<Integer, Integer>();
	protected static Map<Integer, Game> games = new HashMap<Integer, Game>();
